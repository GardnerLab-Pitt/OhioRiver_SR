...
corr_coef <- read.csv("C:/Users/samsi/OneDrive - University of Pittsburgh/OhioRiver_RS/LC02_Corr_Coef.csv") 

correction_coef_99 <- corr_coef %>%
  filter(fit %in% c(NA, "98_quant")) %>%
  dplyr::select(-fit)

sr_clean <- read.csv("C:/Users/samsi/OneDrive - University of Pittsburgh/LC02_SR_Clean.csv")

```

```{r}
setwd("C:/Users/samsi/OneDrive - University of Pittsburgh/OhioRiver_RS")

in_situ_raw <- read_feather("wqp_lagos_usgs_long_methods.feather")
...
# Adding band raitios , color metrics for model predictors 
```{r}
