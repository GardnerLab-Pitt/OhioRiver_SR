...
sr_clean <- read.csv("C:/Users/samsi/OneDrive - University of Pittsburgh/OhioRiver_SR/Data/LC02_SR_Clean.csv")
```
...
sr_final <- sr_clean %>% filter(SiteID %in% sites_within$SiteID)
