...
#Spatial join or filter nhd waterbodies (lakes/ponds) to huc 8 watersheds within the Ohio River Basin.
```{r}
...
set.seed(100)
nhd_sample <- OhioRiver_waterbodies %>%
  sample_n(size = 5)

#write .shp to add into gee as an asset
write_sf(nhd_sample, "C:/Users/samsi/OneDrive - University of Pittsburgh/nhd_sample_lake_pull", driver = 'ESRI Shapefile')
