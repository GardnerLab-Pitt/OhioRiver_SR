...
```{r}
#This file and code below is meant to explore the new AOI (Ohio River Basin) I will be working with and the data within it. What I want to address are how many lakes are there in this basin, how many flowlines are covered within the RiverSF dataset, how many samples are included in AquaSat, etc.  
```
