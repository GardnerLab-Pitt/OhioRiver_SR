...
huc2_basins <- read_sf(dsn="C:/Users/samsi/OneDrive - University of Pittsburgh/Shapefiles/HUC2_Merge_Shapefile/HUC2_Merge", layer="HUC2_Merge") 
...
folds <- CreateSpacetimeFolds(train, spacevar = "long_group", timevar = "time_group")
...
kbl(evals, caption="Table") %>%
kable_classic(full_width = T) %>% 
save_kable("C:/Users/samsi/OneDrive - University of Pittsburgh/OhioRiver_SR/Plots/my_latex_table.png")
...
ggplot(output , aes(x = (Actual), y = (Predicted))) + 
  ...
  xlab("Measured  (ug/L)") +
  ylab("Predicted (ug/L)")+
  labs(subtitle = "AOI filter contains removing Mid-Atlantic Region",title = 'Base Model (< 200 ug/L), AOI Filter + outlier removal (90th percentile)')+
  stat_poly_eq() +
  theme_few() 
```
...
#ffsResults <- read_feather("C:/Users/samsi/OneDrive - University of Pittsburgh/OhioRiver_RS/ffsResults_20230305.feather")
