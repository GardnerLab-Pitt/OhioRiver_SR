...
#location_data <- read_feather("C:/Users/samsi/OneDrive - University of Pittsburgh/OhioRiver_RS/parametersMunged_corrected_v4.feather") %>% 
#filter(SiteID %in% matchup$SiteID) %>% 
#distinct(SiteID, .keep_all = TRUE) %>% 
#select(SiteID, lat, long)

#matchup <- left_join(matchup, location_data)
...
outliers <- read_csv("C:/Users/samsi/OneDrive - University of Pittsburgh/OhioRiver_RS/outliers_sum.csv")
